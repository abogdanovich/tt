...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Image'
        db.create_table(u'timecard_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('timecard', ['Image'])
        ...
        db.send_create_signal('timecard', ['User'])
        ...
        db.send_create_signal('timecard', ['UserTime'])
        ...
        db.send_create_signal('timecard', ['UserDepartament'])
        ...
        db.send_create_signal('timecard', ['UserProfession'])
        ...
        db.send_create_signal('timecard', ['UserRoles'])
        ...
        db.send_create_signal('timecard', ['UserModule'])
        ...
        db.send_create_signal('timecard', ['UserPost'])
        ...
        db.send_create_signal('timecard', ['UserPostComment'])
        ...
        db.send_create_signal('timecard', ['CalendarDaysOff'])
        ...
        db.send_create_signal('timecard', ['UserMissedHours'])
        ...
        db.send_create_signal('timecard', ['Boss_notice'])
        ...
        db.send_create_signal('timecard', ['User_duty'])
        ...
        db.create_table(u'timecard_projects', (
            ...
            ('project_service', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal('timecard', ['Projects'])
        ...
        db.send_create_signal('timecard', ['UserProjectAssignments'])
        ...
        db.send_create_signal('timecard', ['Reports'])
        ...
        db.send_create_signal('timecard', ['Votes'])
        ...
        db.send_create_signal('timecard', ['ProjectThread'])
        ...
        db.send_create_signal('timecard', ['Offices'])
        ...
        db.send_create_signal('timecard', ['Reservation_Categories'])
        ...
        db.send_create_signal('timecard', ['Reservation_Objects'])
        ...
        db.send_create_signal('timecard', ['Reservation_History'])


    def backwards(self, orm):
        # Deleting model 'Image'
        db.delete_table(u'timecard_image')
    ...
    models = {
        ...
        'timecard.projects': {
            ...
            'project_service': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'})
        },
        'timecard.projectthread': {
        ...
        'timecard.reservation_categories': {
            'Meta': {'object_name': 'Reservation_Categories'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'office': ('django.db.models.fields.CharField', [], {'max_length': '2'})
        },
        'timecard.reservation_history': {
            'Meta': {'object_name': 'Reservation_History'},
            'event': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'obj': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timecard.Reservation_Objects']", 'db_index': 'False'}),
            'status': ('django.db.models.fields.BooleanField', [], {}),
            'user': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'timecard.reservation_objects': {
            'Meta': {'object_name': 'Reservation_Objects'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timecard.Reservation_Categories']", 'db_index': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_avaliable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timecard.User']", 'db_index': 'False'})
        },
        'timecard.user': {
        ...
        'timecard.userdepartament': {
            'Meta': {'object_name': 'UserDepartament'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'timecard.usermissedhours': {
        ...
        'timecard.userprofession': {
            'Meta': {'object_name': 'UserProfession'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'timecard.userprojectassignments': {
