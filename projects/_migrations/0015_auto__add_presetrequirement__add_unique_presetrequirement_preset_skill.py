...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_presetrequirement', (
        ...
        db.send_create_signal('projects', ['PresetRequirement'])

        # Adding unique constraint on 'PresetRequirement', fields ['preset', 'skill']
        db.create_unique('projects_presetrequirement', ['preset_id', 'skill_id'])

        # Adding unique constraint on 'Preset', fields ['title']
        db.create_unique('projects_preset', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Preset', fields ['title']
        db.delete_unique('projects_preset', ['title'])

        # Removing unique constraint on 'PresetRequirement', fields ['preset', 'skill']
        db.delete_unique('projects_presetrequirement', ['preset_id', 'skill_id'])

        # Deleting model 'PresetRequirement'
        db.delete_table('projects_presetrequirement')
    ...
    models = {
        ...
        'projects.presetrequirement': {
            'Meta': {'unique_together': "(('preset', 'skill'),)", 'object_name': 'PresetRequirement'},
            'desc': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'preset': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'requirements'", 'null': 'True', 'to': "orm['projects.Preset']"}),
            'skill': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'presets'", 'null': 'True', 'to': "orm['cv.Skill']"})
        },
        'projects.project': {
