...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('projects_project', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.customer'
        db.alter_column('projects_project', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Customer']))
