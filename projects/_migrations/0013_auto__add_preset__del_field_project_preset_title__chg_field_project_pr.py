...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Preset'
        db.create_table('projects_preset', (
        ...
        db.send_create_signal('projects', ['Preset'])

        # Deleting field 'Project.preset_title'
        db.delete_column('projects_project', 'preset_title')


        # Renaming column for 'Project.preset' to match new field type.
        db.rename_column('projects_project', 'preset', 'preset_id')
        # Changing field 'Project.preset'
        db.alter_column('projects_project', 'preset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Preset'], null=True))
        # Adding index on 'Project', fields ['preset']
        db.create_index('projects_project', ['preset_id'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['preset']
        db.delete_index('projects_project', ['preset_id'])

        # Deleting model 'Preset'
        db.delete_table('projects_preset')
        ...
        # Renaming column for 'Project.preset' to match new field type.
        db.rename_column('projects_project', 'preset_id', 'preset')
        # Changing field 'Project.preset'
        db.alter_column('projects_project', 'preset', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'projects.project': {
            ...
            'preset': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['projects.Preset']", 'null': 'True', 'blank': 'True'}),
