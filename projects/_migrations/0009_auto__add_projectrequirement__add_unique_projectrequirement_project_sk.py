...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_projectrequirement', (
        ...
        db.send_create_signal('projects', ['ProjectRequirement'])

        # Adding unique constraint on 'ProjectRequirement', fields ['project', 'skill']
        db.create_unique('projects_projectrequirement', ['project_id', 'skill_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectRequirement', fields ['project', 'skill']
        db.delete_unique('projects_projectrequirement', ['project_id', 'skill_id'])

        # Deleting model 'ProjectRequirement'
        db.delete_table('projects_projectrequirement')
