...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.is_pause'
        db.delete_column('projects_project', 'is_pause')

        # Adding field 'Project.pause'
        db.add_column('projects_project', 'pause',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.is_pause'
        db.add_column('projects_project', 'is_pause',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Project.pause'
        db.delete_column('projects_project', 'pause')
