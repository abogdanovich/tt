...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.preset'
        db.add_column('projects_project', 'preset',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Project.customer'
        db.alter_column('projects_project', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customers.Customer']))

        # Changing field 'Project.dev_time'
        db.alter_column('projects_project', 'dev_time', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Project.preset'
        db.delete_column('projects_project', 'preset')


        # Changing field 'Project.customer'
        db.alter_column('projects_project', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['customers.Customer']))

        # Changing field 'Project.dev_time'
        db.alter_column('projects_project', 'dev_time', self.gf('django.db.models.fields.IntegerField')(default=0))
