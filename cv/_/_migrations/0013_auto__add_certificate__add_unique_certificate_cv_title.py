...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cv_certificate', (
        ...
        db.send_create_signal('cv', ['Certificate'])

        # Adding unique constraint on 'Certificate', fields ['cv', 'title']
        db.create_unique('cv_certificate', ['cv_id', 'title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Certificate', fields ['cv', 'title']
        db.delete_unique('cv_certificate', ['cv_id', 'title'])

        # Deleting model 'Certificate'
        db.delete_table('cv_certificate')
