...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CVSkill.desc'
        db.alter_column('cv_cvskill', 'desc', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'CVSkill.desc'
        db.alter_column('cv_cvskill', 'desc', self.gf('django.db.models.fields.TextField')())
