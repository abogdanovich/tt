...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cv_prevscreenshot', (
        ...
        db.send_create_signal('cv', ['PrevScreenshot'])

        # Adding model 'PrevProject'
        db.create_table('cv_prevproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('cv', ['PrevProject'])

        # Adding unique constraint on 'PrevProject', fields ['cv', 'title']
        db.create_unique('cv_prevproject', ['cv_id', 'title'])


    def backwards(self, orm):
        # Removing unique constraint on 'PrevProject', fields ['cv', 'title']
        db.delete_unique('cv_prevproject', ['cv_id', 'title'])

        # Deleting model 'PrevScreenshot'
        db.delete_table('cv_prevscreenshot')

        # Deleting model 'PrevProject'
        db.delete_table('cv_prevproject')
