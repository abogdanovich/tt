...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        print "Make Permissions for some positions. It take some seconds..."
        for pos in orm['cv.Position'].objects.all():
            if pos.name == "Marketing Manager" or pos.name == "Marketing Director":
                pos.permissions = "1"*55
                pos.save()
