...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CVSkill.cv'
        db.alter_column('cv_cvskill', 'cv_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cv.CV']))

    def backwards(self, orm):

        # Changing field 'CVSkill.cv'
        db.alter_column('cv_cvskill', 'cv_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cv.CV']))
